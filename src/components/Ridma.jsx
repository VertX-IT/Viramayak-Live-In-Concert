  ...
  return (
    <section className="flex flex-col h-screen items-center justify-center mx-28">
      <div className='text-center mb-24'>
        <h1 className='font-headings text-primary text-6xl'>
          FEATURING
        </h1>
        <h2 className='text-4xl'>RIDMA WEERAWARDENE</h2>
      </div>
      <div className='flex flex-row mx-auto items-center w-9/12 h-min-[60vh]'>
        <img
          src={ridma}
          alt='Ridma'
          className='w-[600px] object-contain mr-4'
        />
        <p className='text-center text-xl w-5/6'>
          ...
          voice that resonates with the soul, he has won the hearts of music lovers across the nation. Don't miss the
          chance to witness Ridma's extraordinary talent and his unforgettable contribution to the world of music at the
